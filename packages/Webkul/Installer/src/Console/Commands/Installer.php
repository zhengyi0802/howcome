...
class Installer extends Command
{
    ...
    public function handle()
    {
        ...
        $this->info(app(BagistoDatabaseSeeder::class)->run([
            'default_locale'     => $applicationDetails['default_locale'] ?? 'zh_TW',
            'allowed_locales'    => $applicationDetails['allowed_locales'] ?? ['zh_TW'],
            'default_currency'   => $applicationDetails['default_currency'] ?? 'TWD',
            'allowed_currencies' => $applicationDetails['allowed_currencies'] ?? ['TWD'],
        ]));
