...
return [
    ...
    [
        ...
        'fields' => [
            [
                ...
                'name'          => 'enable_line',
                'title'         => 'admin::app.configuration.index.customer.settings.social-login.enable-line',
                'type'          => 'boolean',
                'channel_based' => true,
            ], [
                'name'          => 'enable_github',
    ...
    [
        ...
        'key'    => 'sales.payment_methods.ecpay',
        'name'   => 'admin::app.configuration.index.sales.payment-methods.ecpay',
        'info'   => 'admin::app.configuration.index.sales.payment-methods.ecpay-info',
        'sort'   => 1,
        'fields' => [
            [
                'name'          => 'title',
