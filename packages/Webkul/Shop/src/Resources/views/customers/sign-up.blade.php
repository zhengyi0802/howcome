                ...
                <x-shop::form :action="route('shop.customers.register.store')">
                    ...
                    <x-shop::form.control-group>
                        <x-shop::form.control-group.label class="">
                            @lang('shop::app.customers.signup-form.upper-name') : {{ $upper->id }}
                        </x-shop::form.control-group.label>

                        <x-shop::form.control-group.control
                            type="text" name="upper_id" value="{{ $upper_id }}" hidden>
                        </x-shop::form.control-group.control>

                        <x-shop::form.control-group.error control-name="upper_id" />
                    </x-shop::form.control-group>

                    {!! view_render_event('bagisto.shop.customers.signup_form.user_id.after') !!}
