...
<!--
                            <li data-link='#pay-confirm-popup2'>
                                ...
                                <div class="ecpay-card-info-tab ecpay-pl-content">
                                    ...
                                    <dl class="ecpay-select-input ecpay-cit-item ecpay-col-a-100">
                                        ...
                                        <dd>
                                            <input type="tel" class="ecpay-cc-card" maxlength="19" placeholder="0000 0000 0000 0000" id="cardnum"/>
                                            <div class="ecpay-card-status-line">
                                                <span class="ecpay-white _Card_Num">請輸入卡號</span>
                                                <span class="ecpay-card-detail"><i class="_Card_Type"></i></span>
                                            </div>
                                        </dd>
                                    </dl>
                                    ...
                                    <div class="ecpay-cit-item-box">
                                        <dl class="ecpay-select-input ecpay-cit-item">
                                            ...
                                            <dd>
                                                <input type="tel" class="ecpay-date" maxlength="7" placeholder="MM / YY" id="valid">
                                                <div class="ecpay-card-status-line _New_Card_Valid" style="display:none">
                                                    <span class="ecpay-red">請輸入有效期限</span>
                                                </div>
                                            </dd>
                                        </dl>
                                        <dl class="ecpay-select-input ecpay-cit-item">
                                            <dt>
                                                ...
                                                <span class="ecpay-cit-title">末三碼</span>
                                            </dt>
                                            <dd>
                                                    <input class="ecpay-cc-cvc" maxlength="3" name="credit-cvc" placeholder="末三碼" type="tel" id = "cvc">
                                                <div class="ecpay-card-status-line _New_Card_CVC" style="display:none">
                                                    <span class="ecpay-red">請輸入末三碼/安全碼</span>
                                                </div>
                                            </dd>
                                        </dl>
                                    </div>
                            ...
                            <li data-link="#pay-confirm-popup6" class="">
                                <div class="ecpay-pl-intro">
                                    <span class="ecpay-pl-radio"></span>
                                    <div class="ecpay-pl-type">信用卡付款(銀聯卡)</div>

                                    <div class="ecpay-pl-icon-type">
                                        <span class="ecpay-upay">VISA</span>
                                    </div>
                                </div>
                                ...
                                <div class="ecpay-card-info-tab ecpay-pl-content">
                                    <dl class="ecpay-select-input ecpay-cit-item ecpay-col-a-100">
                                        <dt>
                                            <span class="ecpay-cit-title">選擇後將轉導至銀聯卡頁面完成交易。 </span>
                                        </dt>
                                        <dd class="ecpay-pl-note-box">
                                            <h4 class="ecpay-pnb-title">注意事項</h4>
                                            <ul class="ecpay-pnb-list">
                                                <li>僅支援一次付清付款。</li>
                                            </ul>
                                        </dd>
                                    </dl>
                            ...
                            <li data-link='#pay-confirm-popup7'>
                                <div class="ecpay-pl-intro">
                                    <span class="ecpay-pl-radio"></span>
                                    <div class="ecpay-pl-type"><img src="https://www.ecpay.com.tw/Content/themes/activities/inpay2/images/events/apple-pay.svg" class="ecpay-plt-img" alt="apple pay"></div>
                                </div>

                                <div class="ecpay-card-info-tab ecpay-pl-content">
                                    <dl class="ecpay-select-input ecpay-cit-item ecpay-col-a-100">
                                        <dt>
                                            <span class="ecpay-cit-title">選擇後將喚起 Apple Wallet 完成交易。</span>
                                        </dt>
                                        <dt>
                                            <span class="ecpay-cit-title"><img src="https://www.ecpay.com.tw/Content/themes/activities/inpay2/images/events/apple-pay-mark.svg" class="ecpay-ap-ic" alt="apple pay"></span>
                                        </dt>
                                        
                                        <dd>
                                            <div class="ecpay-pl-note-box">
                                                <h4 class="ecpay-pnb-title">注意事項</h4>
                                                <ul class="ecpay-pnb-list">
                                                    <li>僅支援一次付清付款。</li>
                                                </ul>
                            ...
                            <li data-link='#pay-confirm-popup3'>
                                <div class="ecpay-pl-intro">
                                    <span class="ecpay-pl-radio"></span>
                                    <div class="ecpay-pl-type">ATM</div>
                                </div>

                                <div class="ecpay-card-info-tab ecpay-pl-content">
                                    <dl class="ecpay-select-input ecpay-cit-item ecpay-col-a-100">
                                        <dt>
                                            <span class="ecpay-cit-title">選擇銀行</span>
                                        </dt>
                                        <dd>
                                            <label class="ecpay-select-tab">
                                                <select id="ATM">
                                                    <option value='0'>請選擇銀行</option>
                                                    <option value='1'>中國信託</option>
                                                    <option value='2'>台新銀行</option>
                                                    <option value='3'>玉山銀行</option>
                                                </select>
                                            </label>
                                            <div class="ecpay-card-status-line _New_Bank"  style="display:none">
                                                <span class="ecpay-red">請選擇銀行</span>
                                            </div>
                                        </dd>
                                        <dd class="ecpay-pl-note-box">
                                            <h4 class="ecpay-pnb-title">注意事項</h4>
                                            <ul class="ecpay-pnb-list">
                                                <li>持以上銀行發行之金融卡並選擇該銀行免跨行手續費；選擇其他銀行須支付跨行手續費15元。</li>
                                            </ul>
                                        </dd>
                                    </dl>
                                </div>
                            ...
                            <li data-link='#pay-confirm-popup4'>
                                <div class="ecpay-pl-intro">
                                    <span class="ecpay-pl-radio"></span>
                                    <div class="ecpay-pl-type">超商代碼</div>

                                    <div class="ecpay-pl-icon-type">
                                        <span class="ecpay-ok">ok</span>
                                        <span class="ecpay-seven">seven</span>
                                        <span class="ecpay-hilife">hilife</span>
                                        <span class="ecpay-family">family</span>
                                    </div>
                                </div>
                                ...
                                <div class="ecpay-card-info-tab ecpay-pl-content">
                                    <dl class="ecpay-select-input ecpay-cit-item ecpay-col-a-100">
                                        <dt>
                                            <span class="ecpay-cit-title">請至超商機台輸入代碼，產生繳費單後前往櫃台繳費。</span>
                                        </dt>
                                        <dd class="ecpay-pl-note-box">
                                            <h4 class="ecpay-pnb-title">注意事項</h4>
                                            <ul class="ecpay-pnb-list">
                                                <li>請於 <span style="color:#FF0000" class="ecpay-red">7天內</span> 至超商列印繳費單並完成繳費。</li>
                                            </ul>
                                        </dd>
                                    </dl>
                                </div>
                            ...
                            <li data-link='#pay-confirm-popup5'>
                                <div class="ecpay-pl-intro">
                                    <span class="ecpay-pl-radio"></span>
                                    <div class="ecpay-pl-type">超商條碼</div>
                                ...
                                <div class="ecpay-card-info-tab ecpay-pl-content">
                                    <dl class="ecpay-select-input ecpay-cit-item ecpay-col-a-100">
                                        <dt>
                                            <span class="ecpay-cit-title">需自行列印條碼繳費單後，前往超商櫃台繳費。</span>
                                        </dt>
                                        <dd class="ecpay-pl-note-box">
                                            <h4 class="ecpay-pnb-title">注意事項</h4>
                                            <ul class="ecpay-pnb-list">
                                                <li>付款成功後，系統將於1至5個工作日發送繳款成功訊息。</li>
                                                <li>本訂單超商條碼的繳費期限為7天，請務必於期限內進行繳款，例：08/01的20:15購買商品，繳費期限為7天，表示08/08的20:15前您必須前往繳費。</li>
                                            </ul>
                                        </dd>
                                    </dl>
                                </div>
...
-->
        ...
        <div class="flex flex-wrap gap-x-11 gap-y-8 justify-between mt-11 pt-7 border-t border-[#E9E9E9]">
            ...
            <div class="grid gap-4 place-content-baseline max-w-[200px] max-868:w-full max-868:max-w-full max-md:max-w-[200px] max-sm:max-w-full">
                ...
                <p class="text-sm" style="background-color:green; color:white">
                    <a href="https://linkpay.tw/91047074"  target="_blank">{{ core()->getConfigData('sales.payment_methods.' . $order->payment->method . '.title') }}</a>
                </p>
