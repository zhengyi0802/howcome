    ...
    >
        ...
        <x-shop::form.control-group>
            ...
            <x-shop::form.control-group.control
                ...
                name="upper_id"
                rules="required"
                :value="old('upper_id') ?? $customer->upper_id"
                :label="trans('shop::app.customers.account.profile.upper_id')"
            />

            <x-shop::form.control-group.error control-name="upper_id" />
        </x-shop::form.control-group>

        {!! view_render_event('bagisto.shop.customers.account.profile.edit_form_controls.upper_id.after') !!}
        ...
        <x-shop::form.control-group>
            ...
            <x-shop::form.control-group.control
                ...
                :label="trans('shop::app.customers.account.profile.bank_name')"
                :placeholder="trans('shop::app.customers.account.profile.bank_name')"
            />

            <x-shop::form.control-group.error control-name="bank_name" />
        </x-shop::form.control-group>

        {!! view_render_event('bagisto.shop.customers.account.profile.edit_form_controls.bank_name.after') !!}
        ...
        <x-shop::form.control-group>
            ...
            <x-shop::form.control-group.control
                ...
                :label="trans('shop::app.customers.account.profile.bank_number')"
                :placeholder="trans('shop::app.customers.account.profile.bank_number')"
            />

            <x-shop::form.control-group.error control-name="bank_number" />
        </x-shop::form.control-group>

        {!! view_render_event('bagisto.shop.customers.account.profile.edit_form_controls.bank_number.after') !!}
        ...
        <x-shop::form.control-group>
            ...
            <x-shop::form.control-group.control
                ...
                :label="trans('shop::app.customers.account.profile.bank_account')"
                :placeholder="trans('shop::app.customers.account.profile.bank_account')"
            />

            <x-shop::form.control-group.error control-name="bank_account" />
        </x-shop::form.control-group>

        {!! view_render_event('bagisto.shop.customers.account.profile.edit_form_controls.bank_account.after') !!}
