<x-shop::layouts.account>
    ...
    <div class="grid grid-cols-1 gap-y-6 mt-8">
        ...
        {!! view_render_event('bagisto.shop.customers.account.profile.share_link.before') !!}

        <div class="grid grid-cols-[2fr_3fr] w-full px-8 py-3 border-b border-[#E9E9E9]">
            <p class="text-sm font-medium">
               @lang('shop::app.customers.account.profile.share-link')
            </p>
            <p>
               {{ "https://www.howcome.com.tw/customer/register?upper_id=".$customer->id }}
               {!! QrCode::size(200)->generate("https://www.howcome.com.tw/customer/register?upper_id=".$customer->id) !!}
            </p>
        </div>

        {!! view_render_event('bagisto.shop.customers.account.profile.share_link.after') !!}

        {!! view_render_event('bagisto.shop.customers.account.profile.upper_id.before') !!}

        <div class="grid grid-cols-[2fr_3fr] w-full px-8 py-3 border-b border-[#E9E9E9]">
            <p class="text-sm font-medium">
                @lang('shop::app.customers.account.profile.upper-name')
            </p>

            <p class="text-sm text-[#6E6E6E] font-medium">
                {{ $customer->upper->last_name . $customer->upper->first_name }}
            </p>
        </div>

        {!! view_render_event('bagisto.shop.customers.account.profile.upper_id.after') !!}
        ...
        {!! view_render_event('bagisto.shop.customers.account.profile.bank_name.before') !!}

        <div class="grid grid-cols-[2fr_3fr] w-full px-8 py-3 border-b border-[#E9E9E9]">
            <p class="text-sm font-medium">
                @lang('shop::app.customers.account.profile.bank_name')
            </p>
        ...
        {!! view_render_event('bagisto.shop.customers.account.profile.bank_name.after') !!}

        {!! view_render_event('bagisto.shop.customers.account.profile.bank_number.before') !!}

        <div class="grid grid-cols-[2fr_3fr] w-full px-8 py-3 border-b border-[#E9E9E9]">
            <p class="text-sm font-medium">
                @lang('shop::app.customers.account.profile.bank_number')
            </p>
        ...
        {!! view_render_event('bagisto.shop.customers.account.profile.bank_number.after') !!}

        {!! view_render_event('bagisto.shop.customers.account.profile.bank_account.before') !!}

        <div class="grid grid-cols-[2fr_3fr] w-full px-8 py-3 border-b border-[#E9E9E9]">
            <p class="text-sm font-medium">
                @lang('shop::app.customers.account.profile.bank_account')
            </p>
        ...
        {!! view_render_event('bagisto.shop.customers.account.profile.bank_account.after') !!}

        {!! view_render_event('bagisto.shop.customers.account.profile.downlines.before') !!}

        <div class="grid grid-cols-[2fr_3fr] w-full px-8 py-3 border-b border-[#E9E9E9]">
            <p class="text-sm font-medium">
                @lang('shop::app.customers.account.profile.downlines-total')
            </p>

            <p class="text-sm text-[#6E6E6E] font-medium">
                {{ count($customer->downlines) }}
            </p>
        </div>

        {!! view_render_event('bagisto.shop.customers.account.profile.downlines.after') !!}
