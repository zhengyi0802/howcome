 ...
 */
Breadcrumbs::for('shop.customer.downlines.index', function (BreadcrumbTrail $trail) {
    $trail->parent('shop.customer.profile.index');

    $trail->push(trans('shop::app.customer.account.downlines.title'), route('shop.customer.downlines.index'));
});

Breadcrumbs::for('shop.customer.downlines.view', function (BreadcrumbTrail $trail, $id) {
    $trail->parent('shop.customer.downlines.index');
});
