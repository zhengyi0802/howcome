...
use Webkul\Shop\Http\Controllers\Customer\Account\DownlineController;
    ...
    Route::prefix('customer')->group(function () {
        ...
        Route::group(['middleware' => ['customer']], function () {
            ...
            Route::prefix('account')->group(function () {
                ...
                Route::controller(DownlineController::class)->prefix('downlines')->group(function () {
                    Route::get('', 'index')->name('shop.customers.account.downlines.index');
                });
